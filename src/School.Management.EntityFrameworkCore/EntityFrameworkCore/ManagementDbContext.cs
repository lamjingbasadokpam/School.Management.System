    ...
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(ManagementConsts.DbTablePrefix + "Students", ManagementConsts.DbSchema);
        ...
        {
            b.ToTable(ManagementConsts.DbTablePrefix + "Subjects", ManagementConsts.DbSchema);
            b.ConfigureByConvention(); //auto configure for the base class props
            b.Property(x => x.Name).IsRequired().HasMaxLength(128);
        ...
        {
            b.ToTable(ManagementConsts.DbTablePrefix + "Teachers", ManagementConsts.DbSchema);
